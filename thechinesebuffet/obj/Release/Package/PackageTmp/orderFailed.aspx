<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderFailed.aspx.cs" Inherits="thechinesebuffet.orderFailed" %>
...
<head>
    ...
    <title>The Chinese Buffet - Reservation Failed</title>
    ...
    <div class="main-container default">
        ...
        <div class="default careers-bg first-div">
            ...
            <div class="center-layout">
                ...
                <h1>Reservation</h1>
                <!--/h1-->
                <form id="form1" runat="server" style="font-size:16px;color:black;">
                    ...
                    <p> 
                        <br />
                    <br />
                    The transaction ID number, for your reference is: 
                    <strong><asp:Label ID="lblVendorTxCodeReference" runat="server" Text="Label"></asp:Label></strong>
                    <br/>
                    <br />
                    To call the restaurant directly please call <br/>01204 388222 (bolton)<br/> 01942 820277 (wigan)
                    </p>
	            </asp:panel>
